...
export default function PokemonModal({ speciesUrl, onClose, isTTRPG, onAddToTeam }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 sm:p-8 animate-fade-in" onClick={onClose}>
            <div className="bg-slate-50 rounded-[2rem] w-full max-w-6xl h-[90vh] flex flex-col md:flex-row overflow-hidden border-8 border-red-600 relative shadow-2xl" onClick={e => e.stopPropagation()}>
                ...
                <div className="w-full md:w-5/12 p-8 bg-white flex flex-col overflow-y-auto no-scrollbar border-r-4 border-slate-200 shadow-md z-10">
                ...
                <div className="w-full md:w-7/12 flex flex-col bg-slate-100 relative">
                    <div className="flex bg-slate-200 border-b-4 border-slate-300 sticky top-0 z-20">
