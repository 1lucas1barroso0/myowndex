...
export default function App() {
    ...
    return (
        <div className={`app-root game-edition view-${view} min-h-[100dvh] flex flex-col`}>
            ...
            <footer className="device-footer"><span>MyOwnDex <b>9.16.5</b></span><span>Projeto de fãs · Dados <a href="https://pokeapi.co/about" target="_blank" rel="noreferrer">PokéAPI</a></span></footer>
