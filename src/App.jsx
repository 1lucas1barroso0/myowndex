                ...
                <div className="max-w-[1700px] mx-auto flex flex-col md:flex-row justify-between items-center gap-5">
                    <div className="flex items-center gap-6 w-full md:w-auto">
                        ...
                        <div className="flex bg-red-800 rounded-xl p-1 border-2 border-red-950 shadow-inner">
                            ...
                            <button onClick={() => setView('teambuilder')} className={`px-6 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all outline-none ${view==='teambuilder'?'bg-red-500 text-white shadow-md border-b-2 border-red-700':'text-red-300 hover:text-white'}`}>PC</button>
                        </div>
                    </div>
